    ...
    <div className="min-h-screen bg-gradient-hero">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slide-in-left delay-400">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  as of now i have worked with 3 businesses and  thats a litle  but one thing i know i can get you degitized 
                  you just have to trust me and i will get you there.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Meet <span className="gradient-text"></span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              The talented individual behind ONEQANA, bringing diverse expertise 
