  ...
  const projects = [
    {
      ...
      description: "a modern web application for seeling high end jewelry.",
      ...
      description: "An interactive platform for online learning and courses.",
      tech: ["Next.js", "GraphQL", "PostgreSQL", "Tailwind CSS"],
      gradient: "from-secondary to-secondary-glow",
      featured: true  
    },{
      title: "shincity ",
      category: "Web Application",
      description: "A nyashinski brand website tribute .",
